...
RSpec.describe "/papers", type: :request do
  ...
  let(:valid_attributes) {
    Paper.new(title: "A", venue: "B", year: "1").attributes
  }

  let(:invalid_attributes) {
    Paper.new(title: "", venue: "", year: "a").attributes
  }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      default_paper = Paper.new(title: "_", venue: "_", year: 0)
      let(:new_attributes) {
        default_paper.attributes
      }
      ...
      it "updates the requested paper" do
        ...
        paper.reload
        expect(paper.title).to eq(default_paper.title)
        expect(paper.venue).to eq(default_paper.venue)
        expect(paper.year).to eq(default_paper.year)
      end
